...
Description: This program tests the following functions: default constructor, overloaded operator<< with chaining, explicit-value constructor
			 palindrome, and replace_all
