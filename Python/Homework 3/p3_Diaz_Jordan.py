    ...
    def eat(self):
        ...
        if not self.moved:
            if self.hunt_clock <= 0:
                ...
                if location:
                    #print('Eating: human at {},{}, predator at {},{}'.format( \
                    #      self.x,self.y,location[0],location[1]))
                    self.island.remove(self.island.animal(location[0], location[1]))
                    self.island.remove(self)
                    self.x = location[0]
...
###########################################
def main(predator_breed_time=4, predator_starve_time=3, initial_predators=35, prey_breed_time=1, initial_prey=59,
         human_breed_time=8, human_starve_time=13, human_hunt_time=12, initial_humans=3, size=12, ticks=1000):
    ...
    for i in range(ticks):
        ...
        if not i % 10:
            print("prey: {}, predator: {}, human: {}".format(prey_count, predator_count, human_count))
